...
-- Schema Logicargo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Logicargo` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `Logicargo` ;
...
CREATE TABLE IF NOT EXISTS `Logicargo`.`Paquete` (
  ...
  CONSTRAINT `fk_Paquete_Itinerario1`
    ...
    REFERENCES `Logicargo`.`Itinerario` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `Logicargo`.`Historico_Pauete`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Logicargo`.`Historico_Pauete` (
  `id` INT NOT NULL AUTO_INCREMENT,
